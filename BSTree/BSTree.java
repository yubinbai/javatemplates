...
public class BSTree<Key extends Comparable<? super Key>> {
	...
	// private Node<Key> searchKey(Node<Key> e, Key x) {
	// // algorithm on page 44 of slide
	// if (e == null || x.compareTo(e.getValue()) == 0) {
	// return e;
	// }
	// if (e.getValue().compareTo(x) < 0 )
	// return searchKey(e.getLeftChild(), x);
	// else
	// return searchKey(e.getRightChild(), x);
	// }
